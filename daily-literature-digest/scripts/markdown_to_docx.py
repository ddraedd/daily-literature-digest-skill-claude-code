...
def add_header_footer(document: Document, footer_text: str = "Daily Literature Digest") -> None:
    section = document.sections[0]
...
def convert_markdown_to_docx(
    markdown_path: Path,
    docx_path: Path,
    footer_text: str = "Daily Literature Digest",
    author: str = "Claude",
) -> None:
    ...
    add_header_footer(document, footer_text)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--footer", default="Daily Literature Digest", help="Footer text for each page.")
    parser.add_argument("--author", default="Claude", help="DOCX document author metadata.")
    return parser


def main() -> int:
    args = build_parser().parse_args()
    convert_markdown_to_docx(Path(args.markdown_path), Path(args.docx_path), args.footer, args.author)
